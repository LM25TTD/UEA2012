...
include ("../dao/questaoDao.php");
	...
	questaoAtualizar($_POST['idQuestao'],$_POST['area'],$_POST['disciplina'], $_POST['assunto'] , trim($_POST['enunciado']), trim($_POST['alt1']), trim($_POST['alt2']), trim($_POST['alt3']), trim($_POST['alt4']), trim($_POST['alt5']), $_POST['altCorreta'], $_POST['dificuldade'], $_SESSION['usuarioLogin'], $_SG['link']);
