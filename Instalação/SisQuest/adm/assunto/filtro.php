...
$resultado=assuntoConsultaFiltro($primeiro_registro,$num_por_pagina,$_SG['link']);
?>
...
<div id="container">
    ...
    <div id="body">
        ...
        <form action="../../servico/assuntoDelete.php" method="post" onsubmit="return (existemItensParaExcluir())">
			...
			<p>
             ...
             <p>* Para editar um assunto clique sobre o nome dele</p>
            ...
            <table cellspacing="0">
                ...
                <?php while ($linhas= mysql_fetch_array($resultado)){?>
                	<tr>
                		<td><a href="editar.php?id=<?php echo $linhas['idast'];?>"><?php echo $linhas['nast'];?></a></td>
                		<td><?php echo $linhas['narea'];?></td>
                		<td><?php echo $linhas['ndisc'];?></td>
                		<td><?php echo "<input name=\"excluir[]\" type=\"checkbox\" id=\"".$linhas['idast']."\" value=\"".$linhas['idast']."\">"; ?></td>
                   	</tr>                	
               <?php } ?>   
