...
/>5
				<input type = "radio" name ="dificuldade" value= "0" checked="checked"/>Aleatorio
                    ...
                    <p><input name="send" style="margin-left: 150px;" class="formbutton" value="Resolver" type="submit" /><a class="linkOperacao"href="../resolver_questoes.php">Cancelar e Voltar</a></p>
                </form>
            </fieldset>
