...
$resultado = disciplinaConsultaFiltro($primeiro_registro,$num_por_pagina,$_SG['link']);
?>
...
<div id="container">
    ...
    <div id="body">
		<div id="content">
        	...
        	<form action="../../servico/disciplinaDelete.php" method="post" onsubmit="return (existemItensParaExcluir())">
			...
			<p>
             ...
             <p>* Para editar uma disciplina clique sobre o nome dela</p>
...
<h3>Disciplinas cadastradas</h3>
            ...
            <table cellspacing="0">
                ...
                <?php while ($linhas= mysql_fetch_array($resultado)){?>
                	<tr>
                		<td><a href="editar.php?id=<?php echo $linhas['iddisc'];?>"><?php echo $linhas['ndisc'];?></a></td>
                		<td><?php echo $linhas['narea'];?></td>
                		<td><?php echo "<input name=\"excluir[]\" type=\"checkbox\" id=\"".$linhas['iddisc']."\" value=\"".$linhas['iddisc']."\">"; ?></td>
                	</tr>                	
               <?php } ?>    
