...
{
	$k = null;
	$del = questaoDelete($adeletar, $_SG['link']);
	$k = 1;
}

if(isset($k))
{
	echo "<div align='center'><h3>Questão(ões) excluída(s) com sucesso.</h3></div>";
	echo "<meta http-equiv='refresh' content='3;URL=../{$raiz}/questoes/filtro.php'>";
}else{
	echo "<div align='center'>Ocorreu algum erro, por favor entre em contato com o Webmaster.</div>";
	echo "<meta http-equiv='refresh' content='4;URL=../{$raiz}/questoes/filtro.php'>";
}
}else{
	echo "<div align='center'>Nenhum item para excluir</div>";
	echo "<meta http-equiv='refresh' content='4;URL=../{$raiz}/questoes/filtro.php'>";
}
