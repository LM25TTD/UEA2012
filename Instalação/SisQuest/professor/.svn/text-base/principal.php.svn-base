    ...
    <div id="body">
	  <div id="content">
            ...
            <h3>Ola <?php echo $_SESSION['usuarioNome'];?> seja bem-vindo ao SisQuest</h3>
           	 ...
           	 <blockquote><p>Pelo que vejo, você possui perfil de Professor, sendo assim possui acesso aos cadastros de Áreas, disciplinas e questões, além de poder resolver questões e provas on-line.</p>
