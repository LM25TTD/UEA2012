    ...
    <div id="body">
		<div id="content">
            ...
            <fieldset>
                ...
                <form action="../../servico/areaCadastro.php" method="post" onsubmit="return (verifica(this))">
                    <p>
                    <label for="name">Nome da Área: *</label>
                    <input name="nomeArea" id="nomeArea" descricao="Nome da Área" obrigatorio="1" type="text" /></p>
