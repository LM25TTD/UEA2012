...
<script type="text/javascript" src="../../scripts/validarFormResolucao5.js"></script>
...
<div id="container">
    ...
    <div id="body">
		<div id="content">
            ...
            <h3>Prova <?php echo $_REQUEST['quant'];?> Questões</h3>

            <fieldset>
                <legend>Selecione as opções:</legend>
                <form action="../../servico/gerarProva.php?quant=<?php echo $_REQUEST['quant'];?>&user=<?php $user = "aluno"; echo $user;?>" method="post" name="dados" onSubmit="return enviardados();">
...
/>5
				<input type = "radio" name ="dificuldade" value= "0" checked="checked"/>Aleatorio
                    ...
                    <p><input name="send" style="margin-left: 150px;" class="formbutton" value="Gerar Prova" type="submit" /><a class="linkOperacao"href="../resolver_questoes.php">Cancelar e Voltar</a></p>
                </form>
            </fieldset>
