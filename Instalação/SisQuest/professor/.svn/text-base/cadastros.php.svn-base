    ...
    <div id="body">
		<div id="content">
			<h3>Cadastros</h3>
           	 ...
           	 <blockquote>
             <p>Aqui você pode incluir novos dados no sistema, alterar itens existentes ou excluir dados. Utilize o menu lateral para para definir o tipo de item a ser cadastrado: Areas, Assuntos, Disciplinas ou Questões.</p>
             <p></p>
             </blockquote>
