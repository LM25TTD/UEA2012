        	...
        	if (form.novasenha.value.length<1) 
            {
             alert("Nova Senha é um campo obrigatório!");
      		 return(false);
                ...
                {
                 alert("Você deve confirmar a senha!");
          		 return(false);
                }else{
...
<div id="container">
            ...
            <h3>Alterar Senha</h3>
				<fieldset>
                	<legend>Insira os dados</legend>           
           	    	<form action="../../servico/alterarSenhaAdm.php" name="dados" method="post" onSubmit="return (verifica(this))">
  ...
  <p><input type="submit" style="margin-left: 150px;" class="formbutton" name="button_alterar" id="button_alterar" value="Confirmar" /><a class="linkOperacao" href="filtro.php">Cancelar e Voltar</a></p>
