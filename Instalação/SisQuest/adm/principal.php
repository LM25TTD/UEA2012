    ...
    <div id="body">
	  <div id="content">
            ...
            <h3>Ola <?php echo $_SESSION['usuarioNome'];?> seja bem-vindo ao SisQuest</h3>
           	 ...
           	 <blockquote><p>Pelo que vejo, você possui perfil de Administrador, sendo assim possui acesso aos cadastros de usuários, Áreas, disciplinas e questões, além de poder resolver questões e provas on-line.</p>
             <p>Acesse o menu superior para alternar entre Cadastros, Resolução de Questões e mais opções do portal.</p>
             </blockquote>
         ...
         <div class="sidebar">
            ...
            <li>
                    ...
                    <ul>
                    	<li>
                            <form method="post" class="searchform" action="usuarios/busca_usuario.php" onsubmit="return (verifica(this))" >
                                <p>Nome:</p>
                                <p>
