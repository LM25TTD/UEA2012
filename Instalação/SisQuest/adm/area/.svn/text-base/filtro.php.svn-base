<?php 
include("../../servico/areaConsulta.php");
...
$resultado = areaConsultaFiltro($primeiro_registro,$num_por_pagina,$_SG['link']);
...
<div id="container">
    ...
    <div id="body">
        ...
        <form action="../../servico/areaDelete.php" method="post" onsubmit="return (existemItensParaExcluir())">
        	...
        	<p>* Para editar uma área clique sobre o nome dela</p>
            ...
            <table cellspacing="0">
                ...
                <?php while ($linhas= mysql_fetch_array($resultado)){?>
                	<tr>
                		<td><a href="editar.php?id=<?php echo $linhas['id_area'];?>"><?php echo $linhas['nome_area'];?></a></td>
                		<td><?php echo "<input name=\"excluir[]\" type=\"checkbox\" id=\"".$linhas['id_area']."\" value=\"".$linhas['id_area']."\">"; ?></td>
                	</tr>                	
               <?php } ?>    
            </table>
			</form>
